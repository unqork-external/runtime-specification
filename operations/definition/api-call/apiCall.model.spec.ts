      ...
      definitions: {
        ApiCallModalOptions: {
          properties: {
            message: {
              ...
              examples: ['Please wait while your data is being processed...'],
              type: 'string',
            },
            ...
            titleOnCompletion: {
              description:
                'titleOnCompletion is the title end-users see on the modal after the data processes successfully.',
              examples: ['Data Processing Successfully Completed'],
              type: 'string',
            },
            titleOnError: {
              description:
                'titleOnError is the title end-users see on the modal if the data encounters an error while loading.',
              examples: ['Uh oh! Error Loading Data'],
              type: 'string',
            },
        ...
        ApiCallOptions: {
          ...
          properties: {
            arrayKeyPromote: {
              description:
                "arrayKeyPromote refers to the value that should be used when 'topLevelArray' is set to true.",
              type: 'string',
            },
            assignAPIValues: {
              default: false,
              description:
                'assignAPIValues refers to how to handle/map responses from the API call. When set to true, API response values may be assigned to components directly.',
              type: 'boolean',
            },
            assignEmptyValues: {
              default: true,
              description:
                "If an output comes back empty, you can either have the data store as an empty value or choose not to store the data. By setting this toggle to true, null or empty strings store as empty values. If set to OFF, the values don't record. https://docs.unqork.io/Content/A05-ModEditor-Data_Event/A05006A-Plug-In_Component.htm?Highlight=Assign%20Empty%20Values#:~:text=Assign%20Values%20if%20They%20Are%20Null%20or%20Empty%20String By default, this toggle is set to true.",
              type: 'boolean',
            },
            assumeDataKeyInResponse: {
              default: false,
              description:
                "assumeDataKeyInResponse refers to how to access data from the response of the API Call. When set to true, the 'data.' prefix can be removed from mapping fields.",
              type: 'boolean',
            },
            blockExecution: {
              default: false,
            ...
            assumeRole: {
              default: true,
              description:
                'By default, all requests made with an API_CALL operation will assume the role provided by engineArgs.assumeRoleOverride. To disable this behaviour for a particular operation, set this boolean to false.',
              type: 'boolean',
            },
            ensureJSONPathExistsInResponse: {
              description:
                "ensureJSONPathExistsInResponse lets you set a required property path return value. If the path isn't present in the response body, the call results in an error.",
              type: 'string',
            },
            errorOutputs: {
            ...
            expectBinaryResponse: {
              default: false,
              description:
                "expectBinaryResponse should be enabled when you expect the API call to return a large file, and/or want to store the response in its original file format. When set to true, the response doesn't convert to or store as base64.",
              type: 'boolean',
            },
            flattenToSingleRecord: {
              default: false,
              description:
                'flattenToSingleRecord refers to how the API call results will be stored. When set to true, the module flattens results into a single record value. When set to OFF, the module leaves the unflattened results in multiple values.',
              type: 'boolean',
            },
            headers: {
              type: 'object',
            ...
            inputs: {
              description:
                'inputs refers to the options that let you map data from components in your module into an API call.',
              items: {
            ...
            isMultiPartRequest: {
              default: false,
              description:
                'isMultiPartRequest, when set to true, combines one or more sets of data into a single body.',
              type: 'boolean',
            },
            maximumRetryCount: {
              default: 3,
              description:
                'maximumRetryCount refers to the maximum number of retries on a failed API call. The maximum number of retries is 10.',
              maximum: 10,
              minimum: 0,
              type: 'number',
            },
            method: {
              ...
              enum: ['GET', 'DELETE', 'HEAD', 'OPTIONS', 'POST', 'PUT', 'PATCH', 'PURGE', 'LINK', 'UNLINK'],
              examples: ['GET', 'POST'],
              minLength: 1,
              type: 'string',
            },
            ...
            outputValuesOnly: {
              default: false,
              description:
                'outputValuesOnly refers to how the output from the API call should be handled. When set to true, the API response is not logged and the outputs are appropriately mapped and handled. When set to false, the entire API call response is logged in the DevTools Console before the output handling occurs.',
              type: 'boolean',
            },
            outputs: {
              description:
            ...
            postTriggerOutputs: {
              description:
                'postTriggerOutputs refers to the list of components to trigger after the API call is completed.',
              items: {
            ...
            preTriggerOutputs: {
              description:
                'preTriggerOutputs is the list of components to trigger concurrently when the API call is made.',
              items: {
            ...
            retryDelayInMS: {
              description:
                'retryDelayInMS refers to the number of milliseconds to wait before trying the API call again after it failed. The maximum delay is 10,000 ms.',
              maximum: 10000,
              minimum: 0,
              type: 'number',
            },
            ...
            serviceType: {
              default: 'UNQORK',
              description:
                "serviceType can be set to either 'Unqork' or 'External. Unqork service type has a number of preconfigured, internal API services. These API calls help you create files, convert files, and access or edit submission data. External service type can make an API call to an external source. You must configure these services in Unqork's Services Administration.",
              enum: ['EXTERNAL', 'UNQORK'],
              type: 'string',
            },
            spinnerOptions: {
            ...
            timeoutInMS: {
              description:
                'timeoutInMS refers to the number of milliseconds that pass before the API call times out. The maximum timeout is 120,000 ms.',
              maximum: 120000,
              minimum: 0,
              type: 'number',
            },
            ...
            withCredentials: {
              default: false,
              description:
                'withCredentials refers to the inclusion of credentials on cross-site requests. When set to true, an application can make cross-site access-control requests using credentials, like cookies.',
              type: 'boolean',
            },
          },
          required: ['method', 'url', 'outputs'],
          then: {
            dependentRequired: {
        ...
        ApiCallSpinnerOptions: {
          properties: {
            showCursorSpinner: {
              default: false,
              description:
                'showCursorSpinner, when true, turns the end-users cursor into a spinner while data processes.',
              type: 'boolean',
            },
            showPageSpinner: {
              default: false,
              description:
                'showPageSpinner, when set to true, has the page display a spinning icon while data processes.',
              type: 'boolean',
            },
          },
          type: 'object',
        ...
        ApiInputs: {
          properties: {
            ...
            base64: {
              default: false,
              description:
                'base64, when set to true, prepares the system to receive a base64 file from the API response.',
              type: 'boolean',
            },
            exclude: {
              default: false,
            ...
            optional: {
              default: false,
              description:
                'optional, when true, will not pass the input to the API request body if it is empty or null.',
              type: 'boolean',
            },
            propertyPath: {
              description: 'targetKey refers to the targeted input for the API call.',
              examples: ["value[0]['url']", 'data.something.other'],
              type: 'string',
            },
            required: {
              default: false,
              description:
                'required, when true, ensures the targeted input has a value before moving ahead or saving the module.',
              type: 'boolean',
            },
            targetKey: {
              description: 'targetKey refers to the targeted input for the API call.',
              examples: ['textfield99', 'SGVsbG8gV29ybGQh'],
              minLength: 1,
              type: 'string',
            },
          },
        ...
        ApiOutputArgs: {
          properties: {
            ...
            responseJSONPath: {
              ...
              examples: ['name', 'data.group[0].description'],
              type: 'string',
            },
        ...
        ErrorsArgs: {
          properties: {
            targetKey: {
              description:
                'targetKey refers to the component that is meant to be fired when the API call results in an error.',
              examples: ['errorModal'],
              minLength: 1,
              type: 'string',
            },
        ...
        OutputModifiers: {
          properties: {
            ...
            shouldOverwrite: {
              default: true,
              description:
                'shouldOverwrite will overwrite a preexisting value in the mapped output field when set to true.',
              type: 'boolean',
            },
            shouldValidate: {
              default: false,
              description:
                'shouldValidate will ensure validation occurs based on the output fields settings when set to true.',
              type: 'boolean',
            },
          },
          type: 'object',
