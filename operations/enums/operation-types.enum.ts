export enum OperationTypes {
  ...
  CHART_ADD_SERIES = 'CHART_ADD_SERIES',
  CHART_REMOVE_SERIES = 'CHART_REMOVE_SERIES',
  CHART_RESET_SERIES_VISIBILITY = 'CHART_RESET_SERIES_VISIBILITY',
  CHART_SET_LEGEND_POSITION = 'CHART_SET_LEGEND_POSITION',
  CHART_SET_SERIES = 'CHART_SET_SERIES',
  CHART_TOGGLE_SERIES_VISIBILITY = 'CHART_TOGGLE_SERIES_VISIBILITY',
  ...
  TABLE_SET_FILTER_TYPES = 'TABLE_SET_FILTER_TYPES',
  ...
  TABLE_SET_COLUMN_WIDTH = 'TABLE_SET_COLUMN_WIDTH',
  TABLE_SET_ROW_DENSITY = 'TABLE_SET_ROW_DENSITY',
  TABLE_SET_GLOBAL_FILTER = 'TABLE_SET_GLOBAL_FILTER',
  TABLE_SET_COLUMN_ORDERING = 'TABLE_SET_COLUMN_ORDERING',
