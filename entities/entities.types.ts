...
@Description(
  trimAll(`
An Entity is a data structure within the engine to represent a user-defined model.
`),
)
export class Entity {
  @Required()
  ...
  @Description(
    trimAll(`
    Targets are a collection of engine value references used get and set engine values
  `),
  )
