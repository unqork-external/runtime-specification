...
export class TableStyleTargets {
  ...
  @Css()
  [TableTargetsEnum.tablePaginationToolbar]: CssClassOrProps;
  @Css()
  [TableTargetsEnum.tablePaginationToolbarSelect]: CssClassOrProps;
  @Css()
  [TableTargetsEnum.tablePaginationToolbarSelectMenu]: CssClassOrProps
}
